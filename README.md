...
3. If you have the Makefile extension, simply run the `Makefile` commands in the following order:
    - `make venv`
    - `make activate`
    - `make dependencies`
    - Optional: `make test`
    - `make run`
4. Alternatively copy the commands in the `Makefile` and execute them in your terminal.
